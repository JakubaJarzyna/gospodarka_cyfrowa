...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 18 09:36:04 2023
...
class Employee:
    ...
    def __str__(self):
        return (f"Pracownik: {self.first_name} {self.last_name}, "
                f"Data zatrudnienia: {self.hire_date}, Data urodzenia: {self.birth_date}, "
                f"Adres: {self.city}, ul. {self.street}, {self.zip_code}, Telefon: {self.phone}")
...
class Book:
    ...
    def __str__(self):
        return (f"Książka autorstwa {self.author_name} {self.author_surname}, "
                f"Data publikacji: {self.publication_date}, Liczba stron: {self.number_of_pages}, "
                f"Dostępna w: {self.library}")
...
class Order:
    ...
    def __str__(self):
        ...
        return (f"Zamówienie złożone przez: {self.student}, Obsługiwane przez: {self.employee}, "
                f"Data zamówienia: {self.order_date}, Książki w zamówieniu: {books_str}")
